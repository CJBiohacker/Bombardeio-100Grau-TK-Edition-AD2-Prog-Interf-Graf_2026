...
if __name__ == "__main__":
    ...
    nome_jogador = input("Digite o nome do jogador: ") or "Heroi"
    ...
    escolha_mapa = input("Opção: ").strip()
    ...
    print(f"\n Olá {nome_jogador}! Bem-vindo ao Bombardeio 1000Grau.")
    ...
    while True:
        ...
        print(f"\nTurno: {GerenciadorEstado.ler_sessao().get('turno_atual', 0)} | Inimigos: {len(mapa.inimigos)}")
        print(mapa)
        ...
        if passa_turno:
            ...
            if turno_atual >= limite_turnos:
                limpar_tela()
                print(f"\nTurno Final: {turno_atual}")
                print(mapa)
                print("\n==================================")
                print("PARABÉNS! Você sobreviveu ao Bombardeio!")
                print(f"Você resistiu por {limite_turnos} turnos.")
                print("==================================\n")
