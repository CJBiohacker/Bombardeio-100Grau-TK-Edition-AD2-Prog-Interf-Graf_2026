...
class GameController(object):
    ...
    def iniciar_jogo(self):
        ...
        tamanho = simpledialog.askinteger("Tamanho do Mapa", "Escolha o tamanho (1-Pequeno, 2-Medio, 3-Grande):", minvalue=1, maxvalue=3, initialvalue=2, parent=self.root)
    ...
    def _renderizar_rodada_atual(self, msg_alerta=None, trilhas_fogo=None):
        ...
        if msg_alerta:
            self.view.hud_texto.set("{} | MSG: {}".format(self.view.hud_texto.get(), msg_alerta))
    ...
    def _executar_passagem_turno(self):
        ...
        if turno_atual >= limit:
            ...
            self.desatar_inputs()
            self.view.exibir_game_over("VITORIA!", "Resgate garantido - Tempo limite alcançado com sucesso.", eh_vitoria=True)
            return
